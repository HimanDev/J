...
//            startRecordingVideo();
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mButtonVideo = (ImageView) view.findViewById(R.id.ivStartStop);
...
//                + System.currentTimeMillis() + ".mp4";
        ...
        Toast.makeText(context,mediaFile.getAbsolutePath(),Toast.LENGTH_SHORT).show();
            ...
            mCameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            // UI
                            mButtonVideo.setImageResource(R.drawable.stop);
    ...
    private void stopRecordingVideo() {
            ...
            mButtonVideo.setImageResource(R.drawable.record_video);
...
////            mCameraDevice.createCaptureSession(getSurfaces(), sessionCallback, backgroundHandler);
////        } catch (CameraAccessException e) {
////            e.printStackTrace();
////        }
//
